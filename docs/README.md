...
OctoAcme projects have explicit role definitions with clear ownership:

- **Product Managers (PdM)**: own outcomes and prioritization
- **Project Managers (PM)**: coordinate schedules, risks and communications
- **Developers**: implement and test features
- **UX/UI Designers**: ensure usability and user-centered design
- **Technical Writers**: maintain documentation and knowledge base
- **DevOps/Platform Engineers**: manage infrastructure and deployments
- **Security Leads**: champion security practices
- **Customer/Support Advocates**: represent the customer voice
- **QA**: validate quality
- **Stakeholders**: provide input and approvals

This role clarity supports ownership across initiation, planning, execution and close. Key artifacts (one‑pager, release plan, risk register, acceptance criteria, retrospective action items) each have an accountable owner. See [Roles and Personas](octoacme-roles-and-personas.md) for complete role descriptions.
